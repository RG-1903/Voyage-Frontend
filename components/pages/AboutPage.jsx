...
// Removed teamMembers from props
const AboutPage = () => {
    // --- ADDED: State for team members and loading ---
    const [teamMembers, setTeamMembers] = useState([]);
    const [loading, setLoading] = useState(true);

    // --- ADDED: Fetch team members when component mounts ---
    useEffect(() => {
    ...
    return (
        <div className="pt-32 pb-24 bg-white min-h-screen">
            <div className="container mx-auto px-6">
                ...
                {/* Mission & Story Section (Remains the same) */}
                            ...
                            >
                                <div className="relative overflow-hidden rounded-2xl">
                                    <img
                                        ...
                                        onError={(e) => { e.target.onerror = null; e.target.src = 'https://i.pravatar.cc/150'; }} // Fallback
                                    />
