/*
* FILE: src/components/auth/AdminForgotPasswordPage.jsx
        ...
        <div className="min-h-screen w-full overflow-hidden relative flex items-center justify-center p-6">
          ...
          >
            <div className="text-center mb-10">
              <Mail size={50} className="text-red-400 mx-auto mb-4" />
              <h1 className="text-4xl font-bold text-white">Reset Password</h1>
              <p className="text-slate-300 mt-2">Enter your admin email for an OTP.</p>
            </div>
